    ...
    <div className="container mx-auto max-w-6xl pt-32 pb-20 px-6">
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <aside className="lg:w-1/4 hidden lg:block">
          <div className="sticky top-32 p-6 rounded-2xl bg-white dark:bg-slate-900/50 border border-gray-200 dark:border-white/5 backdrop-blur-sm shadow-lg dark:shadow-none transition-colors duration-300">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Nesta página</h3>
            <nav className="flex flex-col space-y-1" id="toc-nav">
              <a href="#intro" className="sidebar-link px-4 py-2 text-sm text-gray-600 dark:text-slate-400 hover:text-kuid-blue dark:hover:text-white transition-colors block border-l-2 border-transparent">Introdução</a>
              <a href="#coleta" className="sidebar-link px-4 py-2 text-sm text-gray-600 dark:text-slate-400 hover:text-kuid-blue dark:hover:text-white transition-colors block border-l-2 border-transparent">Recolha de Dados</a>
              <a href="#uso" className="sidebar-link px-4 py-2 text-sm text-gray-600 dark:text-slate-400 hover:text-kuid-blue dark:hover:text-white transition-colors block border-l-2 border-transparent">Uso das Informações</a>
              <a href="#partilha" className="sidebar-link px-4 py-2 text-sm text-gray-600 dark:text-slate-400 hover:text-kuid-blue dark:hover:text-white transition-colors block border-l-2 border-transparent">Partilha de Dados</a>
              <a href="#seguranca" className="sidebar-link px-4 py-2 text-sm text-gray-600 dark:text-slate-400 hover:text-kuid-blue dark:hover:text-white transition-colors block border-l-2 border-transparent">Segurança</a>
              <a href="#direitos" className="sidebar-link px-4 py-2 text-sm text-gray-600 dark:text-slate-400 hover:text-kuid-blue dark:hover:text-white transition-colors block border-l-2 border-transparent">Seus Direitos</a>
              <a href="#contato" className="sidebar-link px-4 py-2 text-sm text-gray-600 dark:text-slate-400 hover:text-kuid-blue dark:hover:text-white transition-colors block border-l-2 border-transparent">Contacto</a>
            </nav>
          </div>
        </aside>
        ...
        <article className="lg:w-3/4">
          <div className="mb-10">
            <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-4 tracking-tight">Política de Privacidade</h1>
            <p className="text-gray-600 dark:text-slate-400">Última atualização: <span className="text-kuid-cyan font-bold">19 de Fevereiro de 2026</span></p>
          </div>

          <div className="prose dark:prose-invert prose-lg max-w-none text-gray-700 dark:text-slate-300 space-y-12 transition-colors duration-300">
            
            <section id="intro" className="scroll-mt-32">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3">
                <span className="bg-kuid-blue/10 dark:bg-white/10 p-2 rounded-lg text-kuid-blue dark:text-kuid-cyan font-black">01</span>
                Introdução
              </h2>
            ...
            <section id="coleta" className="scroll-mt-32">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3">
                <span className="bg-kuid-blue/10 dark:bg-white/10 p-2 rounded-lg text-kuid-blue dark:text-kuid-cyan font-black">02</span>
                Recolha de Dados
              </h2>
            ...
            <section id="uso" className="scroll-mt-32">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3">
                <span className="bg-kuid-blue/10 dark:bg-white/10 p-2 rounded-lg text-kuid-blue dark:text-kuid-cyan font-black">03</span>
                Uso das Informações
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-white dark:bg-white/5 p-4 rounded-xl border border-gray-200 dark:border-white/5 shadow-sm dark:shadow-none">
                  <h3 className="font-bold text-gray-900 dark:text-white mb-2">Fornecimento do Serviço</h3>
                  <p className="text-sm">Para criar, gerir e validar o seu endereço digital KUID.</p>
                </div>
                <div className="bg-white dark:bg-white/5 p-4 rounded-xl border border-gray-200 dark:border-white/5 shadow-sm dark:shadow-none">
                  <h3 className="font-bold text-gray-900 dark:text-white mb-2">Comunicação</h3>
                  <p className="text-sm">Para enviar atualizações, alertas de segurança e suporte técnico.</p>
                </div>
                <div className="bg-white dark:bg-white/5 p-4 rounded-xl border border-gray-200 dark:border-white/5 shadow-sm dark:shadow-none">
                  <h3 className="font-bold text-gray-900 dark:text-white mb-2">Melhoria Contínua</h3>
                  <p className="text-sm">Para analisar o uso e melhorar a funcionalidade e experiência do utilizador.</p>
                </div>
                <div className="bg-white dark:bg-white/5 p-4 rounded-xl border border-gray-200 dark:border-white/5 shadow-sm dark:shadow-none">
                  <h3 className="font-bold text-gray-900 dark:text-white mb-2">Segurança</h3>
            ...
            <section id="partilha" className="scroll-mt-32">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3">
                <span className="bg-kuid-blue/10 dark:bg-white/10 p-2 rounded-lg text-kuid-blue dark:text-kuid-cyan font-black">04</span>
                Partilha de Dados
              </h2>
              <p>
            ...
            <section id="seguranca" className="scroll-mt-32">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3">
                <span className="bg-kuid-blue/10 dark:bg-white/10 p-2 rounded-lg text-kuid-blue dark:text-kuid-cyan font-black">05</span>
                Segurança
              </h2>
              <p className="leading-relaxed">
            ...
            <section id="direitos" className="scroll-mt-32">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3">
                <span className="bg-kuid-blue/10 dark:bg-white/10 p-2 rounded-lg text-kuid-blue dark:text-kuid-cyan font-black">06</span>
                Seus Direitos
              </h2>
            ...
            <section id="contato" className="scroll-mt-32">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3">
                <span className="bg-kuid-blue/10 dark:bg-white/10 p-2 rounded-lg text-kuid-blue dark:text-kuid-cyan font-black">07</span>
                Contacto
              </h2>
              <div className="bg-white dark:bg-white/5 p-8 rounded-2xl border border-gray-200 dark:border-white/10 shadow-lg dark:shadow-none">
                ...
                <ul className="space-y-4">
                  <li className="flex items-center gap-3 text-gray-700 dark:text-slate-300">
                    ...
                    <a href="mailto:ndeasdigital@gmail.com" className="hover:text-kuid-blue dark:hover:text-white transition-colors">ndeasdigital@gmail.com</a>
                  </li>
                  <li className="flex items-center gap-3 text-gray-700 dark:text-slate-300">
