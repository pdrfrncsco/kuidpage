    ...
    <section id="solucao" className="py-24 relative transition-colors duration-300">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mb-20 text-center lg:text-left mx-auto lg:mx-0">
          <h2 className="text-4xl lg:text-6xl font-black text-gray-900 dark:text-slate-50 mb-8 tracking-tighter">
            A infraestrutura que <br />
            <span className="text-gradient dark:drop-shadow-[0_0_18px_rgba(0,209,255,0.22)]">muda o jogo.</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {solutions.map((s, i) => (
            <div key={i} className="group p-10 rounded-[32px] bg-white dark:bg-white/[0.04] border border-gray-200 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-white/[0.07] hover:border-kuid-cyan/30 transition-all duration-500 shadow-lg dark:shadow-none">
              <div className="w-14 h-14 rounded-2xl bg-kuid-gradient flex items-center justify-center mb-8 text-slate-950 dark:text-white shadow-xl shadow-kuid-blue/20 transition-transform group-hover:scale-110">
                {s.icon}
              </div>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-slate-100 mb-4 tracking-tight">{s.title}</h3>
