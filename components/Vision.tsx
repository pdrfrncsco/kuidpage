...
const Vision: React.FC = () => {
  return (
    <section className="py-32 bg-deep-blue overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-20">
          <div className="flex-1 order-2 lg:order-1">
             <div className="relative">
                <div className="absolute inset-0 bg-tech-green/10 blur-[100px] rounded-full"></div>
                <img 
                  src="https://picsum.photos/seed/techmap/800/600" 
                  alt="Visão de Futuro" 
          ...
          <div className="flex-1 order-1 lg:order-2">
            <h2 className="text-4xl lg:text-5xl font-extrabold text-white mb-8 leading-tight">
              ...
              <span className="text-tech-green">digital do território.</span>
            </h2>
            ...
            <p className="text-lg text-slate-400 leading-relaxed opacity-70">
